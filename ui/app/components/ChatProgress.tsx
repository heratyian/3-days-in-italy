...
export default function ChatProgress({ loadingHistory = false }: { loadingHistory?: boolean }) {
  ...
  return (
    <div className="chat-progress rounded-3 bg-body-tertiary p-3 mx-3 mb-3">
      <div className="d-flex align-items-center gap-2">
        ...
        <span
          className="small text-body-secondary ms-auto text-nowrap"
          aria-live="off"
          aria-label={`${duration} elapsed`}
        >
          {duration}
        </span>
      </div>
