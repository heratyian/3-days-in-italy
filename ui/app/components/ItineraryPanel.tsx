...
export default function ItineraryPanel({ open, itinerary, places, busy, onClose, onSelectPlace }: {
  ...
  return <div ref={dialog} id="itinerary-panel" className="modal" tabIndex={-1} aria-labelledby="itinerary-title" aria-hidden="true">
    <div className="modal-dialog modal-lg modal-dialog-scrollable">
      <div className="modal-content">
        <div className="modal-header">
          <h2 id="itinerary-title" className="modal-title fs-5">Your itinerary</h2>
          <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close itinerary" />
        </div>
        <div className="modal-body">
          <div className="container">
            <p className="small text-body-secondary" role="status">
              {busy ? (itinerary ? "Planning… Your latest saved plan is shown below." : "Planning your trip…")
